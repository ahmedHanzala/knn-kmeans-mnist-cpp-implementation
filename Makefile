CC=g++
INCLUDE_DIR := $(MNIST_PROJ_ROOT)/include
SRC := $(MNIST_PROJ_ROOT)/src
CFLAGS := -std=c++11 -g
LIB_DATA := libdata.so
...
$(LIB_DATA) : libdir objdir obj/data_handler.o obj/data.o obj/common.o
	$(CC) $(CFLAGS) -shared -o $(MNIST_PROJ_ROOT)/lib/$(LIB_DATA) obj/data_handler.o obj/data.o obj/common.o

libdir :
	mkdir -p $(MNIST_PROJ_ROOT)/lib

objdir:
	mkdir -p $(MNIST_PROJ_ROOT)/obj
...
clean:
	rm -r $(MNIST_PROJ_ROOT)/lib
	rm -r $(MNIST_PROJ_ROOT)/obj
